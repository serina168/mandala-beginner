...
pgnum(s, 2)
goals = [
    ("1.", "進階色彩學",    "色相、明度、彩度、色彩心理學，從理解到精準運用"),
    ("2.", "深化理解與應用","作品解析力，洞察色彩背後的情感與內在狀態"),
    ("3.", "大型木器創作",  "在大型八角板木器上完成一件精緻曼陀羅作品"),
    ("4.", "高級鑽飾裝飾",  "施華洛世奇水晶鑽飾貼附，提升作品至展覽水準"),
...
for i, (n, t, d) in enumerate(goals):
    ...
    txt(s, x + 0.16, y + 0.07, 0.5, 0.3, n, 13, color=ROSE_DEEP, bold=True)
